...
const vertices = [
	vec3(-0.5, -0.5, +0.5),     // 0 base
	vec3(+0.5, -0.5, +0.5),     // 1 base
	vec3(-0.5, -0.5, -0.5),     // 2 base
	vec3(+0.5, -0.5, -0.5),     // 3 base
	vec3(0, 0.5, 0.5), // 4 vertice
	vec3(0, 0.5, -0.5), // 5 vertice
];
...
function _build()
{
	_addFace(0,1,3,2,vec3(0,0,1));
	_addFace(1,4,5,3,vec3(-1,0.5,0));
	_addFace(0,2,5,4,vec3(-1,0.5,0));
	_addSide(0,1,4,vec3(0,0,1));
	_addSide(2,3,5,vec3(0,0,-1));
}
